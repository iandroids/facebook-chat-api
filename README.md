# Unofficial [Facebook](https://aapks.com/apk/facebook/) Chat API
...
[Facebook](https://aapks.com/apk/facebook/) now has an official API for chat bots [here](https://developers.facebook.com/docs/messenger-platform).
